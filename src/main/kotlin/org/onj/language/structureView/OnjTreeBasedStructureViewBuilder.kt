...
class OnjTreeBasedStructureViewBuilder(val psiFile: PsiFile) : TreeBasedStructureViewBuilder() {
    ...
    override fun createStructureViewModel(editor: Editor?): StructureViewModel {
        return OnjStructureViewModel(editor, psiFile)
    }
...
class OnjStructureViewModel(
    editor: Editor?,
    psiFile: PsiFile
) : StructureViewModelBase(psiFile, editor, OnjStructureViewElement(psiFile)), StructureViewModel.ElementInfoProvider {
