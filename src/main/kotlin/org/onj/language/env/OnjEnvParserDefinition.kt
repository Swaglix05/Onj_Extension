...
class OnjEnvParserDefinition : ParserDefinition
{
    private val file = IFileElementType(OnjEnvLanguage)

    override fun createLexer(project: Project?): Lexer = object : FlexAdapter(OnjLexer(null)) { }

    override fun createParser(project: Project?): PsiParser = OnjEnvParser()
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile = OnjEnvFile(viewProvider)
}